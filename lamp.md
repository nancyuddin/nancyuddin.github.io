...
17. I purchased a domain, but you can get a free one [online](https://www.forbes.com/advisor/business/free-domain-name/). Go to your domain DNS settings and add ‘A’ type record which points to your public IPV4 address. You can set the TTL to 60. 
...
18. Add two new fields in the configuration file. The ServerName is going to be the ```domain name``` and ServerAlias is going to be ```www.[Sample website]```.
...
19. Install Certbot to make it secure. 
